'''
Bu komut dosyasi, özellik görünümlerinden 
özellikleri getirecek, 
bunlara katilacak ve bunlari özellik mağazamizda bir veri kümesi olarak kaydedecektir.
'''
...
'''
Feast, farkli özellik görünümlerini bir araya getirmek için entity DataFrame'lerini kullanir. 
Zamanin doğruluğunu sağlamak için Feast, 
feature viewdeki ve entity DataFrame'deki 
entity ve event timestampleri eşleştirir.
...
'''
get_historical_features yöntemi, etiketlerle birlikte entity_df'mizi alır, onu parametre özelliklerine iletilen özelliklerle birleştirir 
ve verilere tanıtıcı görevi gören bir RetrievalJob nesnesi döndürür
'''
